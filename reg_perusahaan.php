                        ...
                        <div class="panel-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group input-group" <label>Username </label>
                                    ...
                                    <input type="text" class="form-control" placeholder="Buat Username Maks. 5 Digit"
                                        name="txtusername" required autofocus />
                                </div>
                        ...
                        &nbsp;&nbsp;
                                ...
                                <div class="form-group input-group" <label>Password</label>
                                    ...
                                    <input type="password" class="form-control"
                                        placeholder="Masukkan Password (Maks. 8)" name="txtpassword" required="">
                                </div>
                                <div class="form-group input-group" <label>Email </label>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                    <input type="text" class="form-control" placeholder="Email Perusahaan"
                                ...
                                <div class="form-group input-group" <label>Alamat </label>
                                    ...
                                    &nbsp;&nbsp;&nbsp;
                                    <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                    <textarea class="form-control" name="txtalamat" oninvalid="InvalidMsg(this);"
                                        oninput="InvalidMsg(this);" required />
                                    </textarea>
                                </div>
                                <br><br>
                                <a href="index.php" class='btn btn btn-sm'>Kembali</a>
                                <button type="submit" class="btn btn-warning btn-sm" name="btnDaftarPer"
                                    title="Masuk Sistem" />Registrasi</button>
                                <br><br>
